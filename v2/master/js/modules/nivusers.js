app.controller('NIVUserCtrl', function($scope,$http,blockUI,$rootScope,alertService,NgTableParams,$filter,$parse,CONSTANTS,ngDialog,dataService,$q){
	...
	angular.extend($scope,{
		...
		{
			blockUI.start('Please Wait...');
			dataService.getData('/ws/getNIVUsers',{}).then(function(response){
				recs=angular.copy(response.data);
				if(recs!='0')
				{
