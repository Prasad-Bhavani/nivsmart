...
<head>
    ...
    <script src="js/modules/monthly_followup.js"></script>
...
<!-- END : Alert Messages -->
                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li class="usercss btn-success"><b>Grade : <?php $user=getEMpDetails(); echo $user['emp_grade_id']; ?></b></li>
                            <li class="usercss btn-success" title="<?php echo $user['emp_name'].'('.$user['dept'].' - '.$user['role'].')'; ?>"><?php if(strlen($user['emp_name'])>10) $dots='...'; else $dots=''; echo substr($user['emp_name'],0,10).$dots.'('.$user['dept'].' - '.$user['role'].')'; ?></li>
                            <li>
                                <div class="dropdown" style="margin-top:5px;" ng-controller="branchSelection" title="Branch Selection">
  <button class="btn btn-success dropdown-toggle" type="button" data-toggle="dropdown"><?php if(!empty($_SESSION['niv_branch'])) echo $_SESSION['niv_branch']; ?>
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="branchselection.php">Go to Branch Selection</a></li>
                           ...
                           <li>
                                <div style="margin-top:5px; margin-left:10px;" title="Logout">
  <a href="../index.php?action=signout" style="text-decoration: none;"><div class="usercss btn-success" type="button">Logout </div></a>
</div>
                            </li>
        ...
        <div class="page-container"> 
            ...
            <div class="page-sidebar menu-compact" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li ng-controller="branchSelection">
                    ...
                    <li>
                        <a href="monthly_followup.php">
                            <i class="menu-icon glyphicon glyphicon-tasks"></i>
                            <span class="menu-text">Monthly Follow-up </span>
                        </a>
                    </li>
                    <!--<li>
                        <a href="reports.php">
