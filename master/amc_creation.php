...
<!-- Page Content -->
            <div class="page-content" ng-controller="amcCreationCtrl">
                <!-- Page Breadcrumb -->
                                                ...
                                                <div class="tabbable">
                                                    ...
                                                    <div class="tab-content tabs-flat">
                                                        <div id="lead" class="tab-pane">
                                                            <div ng-include="'../template/amc_creation.html'"></div>
                                                        </div>

                                                        <div id="leads" class="tab-pane active">
                                                            <div ng-include="'../template/amc_created_leads.html'"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                </div>
                                                </div>
<div ng-if="isLeadView" ng-include="'../template/amcviewlead.html'"></div>
                                    </div>
                    </div>
                </div>
                <!-- /Page Body -->
