                ...
                <div class="navbar-header pull-right">
                    <div class="navbar-account">
                        <ul class="account-area">
                            <li class="usercss btn-success" title="<?php $user=getEMpDetails(); echo $user['emp_name'].'('.$user['dept'].' - '.$user['role'].')'; ?>"><?php if(strlen($user['emp_name'])>10) $dots='...'; else $dots=''; echo substr($user['emp_name'],0,10).$dots.'('.$user['dept'].' - '.$user['role'].')'; ?></li>
                            <li>
