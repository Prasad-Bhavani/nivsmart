                                            ...
                                            <div class="widget-main ">
                                                <div class="tabbable">
                                                    <ul class="nav nav-tabs tabs-flat" id="myTab11">
                                                        <li class="">
                                                            <a data-toggle="tab" href="#lead" aria-expanded="false" ng-click="getInboxLeads()">
                                                                Inbox
                                                            </a>
                                                        </li>
                                                        <li class="active">
                                                            <a data-toggle="tab" href="#myleads" aria-expanded="true" ng-click="getLeads()">
                                                                Leads
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content tabs-flat">
                                                        <div id="lead" class="tab-pane">
                                                            <div ng-include="'template/leads.html'"></div>
                                                        </div>
