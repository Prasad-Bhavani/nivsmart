...
<!-- Page Content -->
            <div class="page-content" ng-controller="NIVUserCtrl">
                <!-- Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table ng-table="tableParams" class="table" show-filter="true">
                    <tr ng-repeat="lead in $data" ng-if="$data.length>0">
                                ...
                                <td data-title="'Serial No'" sortable="'serial_no'" filter="{'serial_no':'text'}" width="15%">{{ lead.serial_no }}</td>
