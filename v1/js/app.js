...
app.filter('getExpensesStatus',function($filter){
	...
	{
		var data='';
		if(admin_status=='') data='Pending at Admin'; else if(master_status=='') data='Pending at Master'; else if(paid_status==0) data='Pending at Accounts'; else if(paid_status==1) data='Paid';
		return data;
	}
});
