                                            ...
                                            <div class="widget-main ">
                                                <div class="tabbable">
                                                    <ul class="nav nav-tabs tabs-flat" id="myTab11">
                                                        <li class="">
                                                            <a data-toggle="tab" href="#followup" aria-expanded="false" ng-click="getFollowupLeads()">
                                                                Follow-up
                                                            </a>
                                                        </li>
                                                        <li class="">
                                                            <a data-toggle="tab" href="#coldleads" aria-expanded="false" ng-click="getTeleColdLeads()">
                                                                Cold Leads
                                                            </a>
                                                        </li>
                                                        <li class="active">
                                                            <a data-toggle="tab" href="#hotleads" aria-expanded="true" ng-click="getHotInboxLeads()">
                                                                Hot Leads
                                                            </a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content tabs-flat">
                                                        ...
                                                        <div id="coldleads" class="tab-pane">
                                                            <div ng-include="'template/hotleads.html'"></div>
                                                        </div>
